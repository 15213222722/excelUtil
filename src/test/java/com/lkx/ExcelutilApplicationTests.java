...
public class ExcelutilApplicationTests {
	...
	public void testXDD() throws Exception
	{
		...
		List<ReportDO> list =  ExcelUtil.readXls("D://05426a25a0b230a5.xlsx",ExcelUtil.getMap(keyValue),"com.lkx.model.ReportDO");
	     for (ReportDO phoneModel : list) {
			System.out.println(phoneModel);
		}
	}
	@Test
